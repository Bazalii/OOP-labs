...
namespace Reports.Clients
{
    public class ConsoleInterface
    {
        ...
        public void GetAvailableCommands()
        {
            ...
            table.AddRow("[yellow]assignEmployee[/]", "[green]Assigns concrete employee to the task[/]");
            table.AddRow("[yellow]getAllTasks[/]", "[green]Shows all the tasks[/]");
            table.AddRow("[yellow]writeTaskById[/]", "[green]Shows the task using the id[/]");
            table.AddRow("[yellow]getLatestTask[/]", "[green]Shows the latest task[/]");
            ...
            table.AddRow("[yellow]changeTask[/]", "[green]Adds changes to the task[/]");
            ...
            table.AddRow("[yellow]changeReportStatus[/]", "[green]Changes report status[/]");
