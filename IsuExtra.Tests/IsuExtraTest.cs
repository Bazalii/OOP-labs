...
namespace IsuExtra.Tests
{
    ...
    public class IsuExtraTest
    {
        ...
        public void Setup()
        {
            ...
            _jointTrainingGroupService.GetStudyGroup("M3204").AddLesson("Monday. 8:20-9:50", 240);
            _jointTrainingGroupService.GetStudyGroup("M3204").AddLesson("Monday. 10:00-11:30", 466);
            ...
            _jointTrainingGroupService.GetStudyGroup("R3301").AddLesson("Monday. 8:20-9:50", 105);
            _jointTrainingGroupService.GetStudyGroup("R3301").AddLesson("Thursday. 10:00-11:30", 310);
            ...
            _jointTrainingGroupService.GetTrainingGroup("Discrete Math").GetStream("DM 1.1").AddLesson("Thursday. 10:00-11:30", 238);
            _jointTrainingGroupService.GetTrainingGroup("Discrete Math").GetStream("DM 1.1").AddLesson("Thursday. 15:20-16:50", 466);
            _jointTrainingGroupService.GetTrainingGroup("Discrete Math").AddStream(new Stream("DM 1.2"));
            _jointTrainingGroupService.GetTrainingGroup("Discrete Math").GetStream("DM 1.2").AddLesson("Monday. 8:20-9:50", 238);
            _jointTrainingGroupService.GetTrainingGroup("Discrete Math").GetStream("DM 1.2").AddLesson("Thursday. 15:20-16:50", 466);
            ...
            _jointTrainingGroupService.GetTrainingGroup("Photonics").GetStream("Ph 1.1").AddLesson("Monday. 10:00-11:30", 238);
            _jointTrainingGroupService.GetTrainingGroup("Photonics").GetStream("Ph 1.1").AddLesson("Wednesday. 15:20-16:50", 466);
            _jointTrainingGroupService.GetTrainingGroup("Photonics").AddStream(new Stream("Ph 1.2"));
            _jointTrainingGroupService.GetTrainingGroup("Photonics").GetStream("Ph 1.2").AddLesson("Tuesday. 11:40-13:10", 238);
            _jointTrainingGroupService.GetTrainingGroup("Photonics").GetStream("Ph 1.2").AddLesson("Thursday. 15:20-16:50", 466);
        }
