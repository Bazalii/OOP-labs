...
namespace Banks.ConsoleInterfaceStructure
{
    public class ConsoleInterface
    {
        ...
        public void Start()
        {
            ...
            AnsiConsole.Markup("[green]This application emulates process of client working with business logic.[/]");
            AnsiConsole.WriteLine(string.Empty);
            ...
            AnsiConsole.WriteLine(string.Empty);
            AnsiConsole.Markup("[green]Every time that you use \"registerClient\" you will work with new client.[/]");
            AnsiConsole.WriteLine(string.Empty);
            AnsiConsole.Markup("[green]All the commands in this app except changePercents work with this client and their accounts.[/]");
            AnsiConsole.WriteLine(string.Empty);
            AnsiConsole.Markup("[green]There are two registered banks: Sber and Spb.[/]");
            AnsiConsole.WriteLine(string.Empty);
            AnsiConsole.Markup("[green]There is also one more registered client Alexey Ivanov.[/]");
            AnsiConsole.WriteLine(string.Empty);
            AnsiConsole.Markup("[green]He has a credit account with Id 2_1 in Spb bank.[/]");
            AnsiConsole.WriteLine(string.Empty);
            AnsiConsole.Markup("[green]You can use all that things to test functionality.[/]");
            AnsiConsole.WriteLine(string.Empty);
